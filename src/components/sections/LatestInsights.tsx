...
import { ArrowRight, FileText, BookOpen, BarChart3, Megaphone } from "lucide-react"

const insights = [
  {
    type: "Press Release",
    icon: Megaphone,
    title: "Next Switch Launches Innovation Lab in Lagos",
    excerpt: "New facility will support 500+ young innovators with mentorship, funding, and technical resources.",
    date: "Mar 15, 2026",
    href: "#",
  },
  {
    type: "Research",
    icon: BarChart3,
    title: "The State of Digital Innovation in Africa 2026",
    excerpt: "Comprehensive report on technology adoption, talent development, and innovation ecosystems across 54 countries.",
    date: "Feb 28, 2026",
    href: "#",
  },
  {
    type: "Insight",
    icon: BookOpen,
    title: "Why Redemptive Innovation Matters for Africa",
  ...
  },
  {
    type: "Announcement",
    icon: FileText,
    title: "Next Switch Academy Opens Applications for 2026 Cohort",
    excerpt: "Intensive 12-month program accepting 100 aspiring tech leaders from across the continent.",
    date: "Jan 20, 2026",
...
export default function LatestInsights() {
  ...
  return (
    <section id="insights" ref={ref} className="relative py-32 overflow-hidden">
