  ...
  return (
    <section ref={ref} className="relative py-24 overflow-hidden">
      ...
      <motion.div style={{ scale }} className="relative z-10 mx-auto max-w-3xl px-6 text-center">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight">Ready for a similar transformation?</h2>
          <p className="mt-4 text-base text-white/30">Let&apos;s explore how we can help you achieve your goals.</p>
          <a
