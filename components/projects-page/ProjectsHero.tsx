        ...
        <AnimatedSection variant="fadeInUp" className="max-w-4xl">
          ...
          <AnimatedSection variant="fadeInUp" delay={0.2}>
            <p className="text-white/80 text-lg md:text-xl lg:text-2xl font-display italic leading-relaxed">
              Showcasing innovation and excellence across web development, mobile apps, custom software, and cutting-edge research.
            </p>
          </AnimatedSection>

          <AnimatedSection variant="fadeInUp" delay={0.3}>
            <p className="text-white/60 text-base md:text-lg mt-6 leading-relaxed max-w-2xl">
              Explore our portfolio of successful projects that have helped businesses transform digitally, scale efficiently, and achieve their goals.
            </p>
          </AnimatedSection>
        </AnimatedSection>
      </div>
