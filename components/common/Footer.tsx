...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    { icon: InstagramIcon, href: "https://instagram.com/nextswitch", label: "Instagram" },
  ...
  return (
    <footer className="bg-black py-16 lg:py-20">
      <div className="container mx-auto px-4 lg:px-12">
          ...
          <div className="lg:col-span-7 flex items-start justify-end">
            <form onSubmit={handleSubmit} className="flex w-full max-w-md">
              <Input
                ...
                className="flex-1 h-12 bg-white border-0 text-foreground placeholder:text-gray-500 rounded-none px-4 focus-visible:ring-0 focus-visible:ring-offset-0"
                required
              />
              <Button
                type="submit"
                className="h-12 px-6 bg-[#006FF5] hover:bg-[#0056cc] text-white rounded-none gap-2 shrink-0"
              >
                Subscribe
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mt-16 pt-8 border-t border-gray-800">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            Next Switch Ltd. @2026
          </p>
