  ...
  return (
    <section ref={ref} className="relative py-24 overflow-hidden">
      ...
      <motion.div style={{ scale }} className="relative z-10 mx-auto max-w-3xl px-6 text-center">
        ...
        >
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight">Ready to build together?</h2>
          <p className="mt-4 text-base text-white/30">
            Schedule a session with our team to explore how we can support your vision.
          </p>
          <a
            href="/booking"
