...
const PressHero = () => {
  return (
    <section className="relative lg:min-h-[90vh] md:min-h-[50vh] min-h-[80vh] flex items-center overflow-hidden bg-[#050616]">
      ...
      <div className="container mx-auto px-4 lg:px-12 relative z-10">
        <AnimatedSection variant="fadeInUp" className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-sm mb-8">
            ...
            <span className="text-white/80 text-sm font-medium">Press Kit</span>
          </div>

          <h1 className="text-3xl md:text-4xl lg:text-6xl text-white leading-tight mb-6 tracking-tight">
            <span className="text-[#00e5ff] italic font-serif">Brand resources</span> for press and media
          </h1>
