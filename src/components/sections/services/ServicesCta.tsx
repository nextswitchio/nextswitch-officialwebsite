...
export default function ServicesCta() {
  ...
  return (
    <section id="contact" ref={ref} className="relative min-h-[80dvh] flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          ...
          <p className="mt-8 max-w-3xl mx-auto text-lg text-white/30 leading-relaxed">
            Whether you&apos;re launching a product, transforming an organization, developing talent,
            or exploring a new opportunity — we&apos;re ready to build with you.
          </p>
